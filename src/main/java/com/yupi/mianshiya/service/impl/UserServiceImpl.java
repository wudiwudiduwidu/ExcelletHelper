...
import static com.yupi.mianshiya.constant.RedisConstant.getUserSignInRedisKey;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "bskj";
@Resource
...
return signList;
    ...
    public boolean addUserSignIn(long userId) {
       // 异步不在意返回结果
        // 默认情况下，CompletableFuture 使用 ForkJoinPool.commonPool()，但可以指定自定义线程池：
        CompletableFuture<Void> signTask = CompletableFuture.runAsync(() -> {
            LocalDate date = LocalDate.now();
